...
namespace org.neuroph.nnet.comp.layer {
    ...
    public class ConvolutionalLayer : FeatureMapsLayer {

        private const long serialVersionUID = -4619196904153707871L;
        /// <summary>
        ...
        static ConvolutionalLayer() {
            DEFAULT_NEURON_PROP.setProperty("inputFunction", typeof(WeightedSum));
            DEFAULT_NEURON_PROP.setProperty("transferFunction", TransferFunctionType.Tanh.ToString()); // <<<--- use Sigmoid, Tanh?        RectifiedLinear
