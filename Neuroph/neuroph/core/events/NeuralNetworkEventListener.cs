...
//ORIGINAL LINE: @FunctionalInterface public interface NeuralNetworkEventListener extends java.util.EventListener
	public interface NeuralNetworkEventListener
	{

		  void handleNeuralNetworkEvent(events.NeuralNetworkEvent @event);
	}
