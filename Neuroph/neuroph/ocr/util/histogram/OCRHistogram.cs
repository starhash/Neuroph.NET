...
namespace org.neuroph.ocr.util.histogram
{
	...
	public class OCRHistogram
	{
		...
		public static int[] widthRowHistogram(BufferedImage image, int row, int letterHeight)
		{
		 ...
		 /// histogram where the words are separated, not letters. </summary>
		 /// <param name="histogram"> classic width histogram </param>
		 /// <param name="spaceGap"> size of the space which will be ignored </param>
		 /// <returns> new histogram with ignored spaces. <br/>
		 /// Previously in histogram these spaces have had values of zero<br/>
		 /// Now they are filled with ones: histogram[i] = 1 </returns>
