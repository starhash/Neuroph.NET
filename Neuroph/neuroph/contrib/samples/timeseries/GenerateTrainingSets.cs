...
namespace org.neuroph.contrib.samples.timeseries
{
	...
	public class GenerateTrainingSets
	{
		...
		public static void Main(string[] args)
		{
			...
			const string directory = "C:\\java\\Neuroph_2.3\\Neuroph\\tutorial\\";
			...
			catch (IOException e)
			{
				...
				System.Console.WriteLine("Failed to generate all data sets.");
				Environment.Exit(1);
			}

			System.Console.WriteLine("Generated data sets.");
		}
