...
//ORIGINAL LINE: @FunctionalInterface public interface LearningEventListener extends java.util.EventListener
	public interface LearningEventListener : java.util.EventListener
	{

		/// <summary>
		/// This method gets executed when LearningRule fires LearningEvent which some class is listening to.
		/// For example, if you want to print current iteration, error etc. </summary>
		/// <param name="event"> holds the information about event tha occured </param>
