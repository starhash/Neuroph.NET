...
namespace org.neuroph.util.io
{
	...
	/// <summary>
	/// Implementation of InputAdapter interface for reading neural network inputs from database. </summary>
	/// <seealso cref= InputAdapter
	/// @author Zoran Sevarac <sevarac@gmail.com> </seealso>
	public class JDBCInputAdapter : InputAdapter
	{
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		...
		/// <summary>
		/// Reads next row from result set and returns input for neural network as array of doubles. </summary>
