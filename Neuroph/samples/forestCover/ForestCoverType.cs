...
namespace org.neuroph.samples.forestCover
{
	...
	public class ForestCoverType
	{
		...
		public static void generateDataSets(Config config)
		{
			...
			Console.WriteLine("***************************************************");
			Console.WriteLine("STEP 1: Generate training (75%) and test (25%) files: ");
			generate.createTrainingAndTestSet();

			Console.WriteLine("***************************************************");
			Console.WriteLine("STEP 2: Balancing training data set to have the same number (3000) of each tree: ");
			generate.createBalancedTrainingSet(3000);

			Console.WriteLine("***************************************************");
			Console.WriteLine("STEP 3: Normalizing balanced training data set: ");
		...
		public static void trainNetwork(Config config)
		{
			...
			Console.WriteLine("***************************************************");
			Console.WriteLine("STEP 4: Creating and Training neural network: ");
		...
		public static void evaluateNetwork(Config config)
		{
			...
			Console.WriteLine("***************************************************");
			Console.WriteLine("STEP 5: Evaluating neural network: ");
			evaluate.evaluate();
		}
